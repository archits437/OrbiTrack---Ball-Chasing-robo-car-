...
const char* ssid = "abcd"; // The name of the WiFi network you want to connect to
...
int in1=19; // The pin number for the first input of the left motor driver
int in2=17; // The pin number for the second input of the left motor driver
int ena=14; // The pin number for the enable pin of the left motor driver
int in3=15; // The pin number for the first input of the right motor driver
int in4=16; // The pin number for the second input of the right motor driver
int enb=27; // The pin number for the enable pin of the right motor driver
...
void forward(int left_speed, int right_speed) { // Define a function to move the robot forward
  digitalWrite(in1, LOW); // Set the in1 pin to HIGH
  digitalWrite(in2, HIGH); // Set the in2 pin to LOW
  digitalWrite(in3, LOW); // Set the in3 pin to HIGH
  digitalWrite(in4, HIGH); // Set the in4 pin to LOW
...
void backward(int left_speed, int right_speed) { // Define a function to move the robot backward
  digitalWrite(in1, HIGH); // Set the in1 pin to LOW
  digitalWrite(in2, LOW); // Set the in2 pin to HIGH
  digitalWrite(in3, HIGH); // Set the in3 pin to LOW
  digitalWrite(in4, LOW); // Set the in4 pin to HIGH
  analogWrite(ena, left_speed); // Set the ena pin to the left_speed value
  analogWrite(enb, right_speed); // Set the enb pin to the right_speed value
}
